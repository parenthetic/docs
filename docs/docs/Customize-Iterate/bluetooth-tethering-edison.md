...
**BT Tethering to Phone's Hotspot**
Pros:
      ...
      * It automatically allows the rig to pick back up on wifi when it finds a known wifi network
      * It consumes less battery on the phone compared to your wifi hotspot.
...
Cons: 
      * It takes more work to set it up 
...
Cons: 
      * Must be manually turned on when you leave known wifi area
      * Must be manually turned off when you come back into a known wifi area
      * It consumes more power and drains your phone battery faster
